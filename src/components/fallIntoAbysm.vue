...
onMounted(() => {
	console.log(canvasBox.value.offsetWidth, '======')
	const innerHeight = canvasBox.value.offsetHeight
	const innerWidth = canvasBox.value.offsetWidth
	const rowCount = 20
    ...
    col.rgb += sin(t*5.);
		...
		shader.fragmentShader = shader.fragmentShader
			...
			.split('gl_FragColor = vec4( outgoingLight, diffuseColor.a );').join(`
